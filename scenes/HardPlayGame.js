// playGame scene
class HardPlayGame extends Phaser.Scene {
    constructor() {
        super({ key: "HardPlayGame", active: false });
    }
    ...
    create() {
        ...
        this.currentBar = localStorage.getItem('BHARDBARS') || 0;
    ...
    jump() {
        ...
        this.ball.setVelocity((this.ball.body.velocity.x > 0) ? gameOptions.ballSpeed : -1, -30);
    }
    ...
    gameLevelUpdate() {
        ...
        localStorage.setItem('BHARDBARS', this.currentBar);
