// playGame scene
class HardPlayGameLevel2 extends Phaser.Scene{
    constructor(){
        super({ key: "HardPlayGameLevel2", active: false });
    }
    ...
    update(){
        ...
        if(score >= 50 ){
            ...
            game.globals.gameDiffculty = "HardPlayGameLevel3";
