// playGame scene
class playGameLevel2 extends Phaser.Scene{
    constructor(){
        super({ key: "PlayGame2", active: false });
    }
    ...
    create(){
        ...
        // adding the ball
        this.ball = this.matter.add.image( game.globals.ballXposition,  game.globals.ballYposition, "ball");
