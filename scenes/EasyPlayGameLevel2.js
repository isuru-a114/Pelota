// playGame scene
class EasyPlayGameLevel2 extends Phaser.Scene {
    constructor() {
        super({ key: "EasyPlayGameLevel2", active: false });
    }
    ...
    update() {
        ...
        // go to next Level
        if (score > 50 && !isLevelAchieved) {
            isLevelAchieved = true;
            gameOptions.bars = 4;
            this.scene.start("CountDown");
            game.globals.gameDiffculty = "EasyPlayGameLevel3";
